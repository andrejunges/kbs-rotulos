        ...
        return (
            <div style={componentStyles.root}>
                <Card style={componentStyles.card}>
                    ...
                    <CardActions>
                        <KBSRaisedButton label='Abrir' primary={true} onTouchTap={this.openRotulo1.bind(this)} />
                    </CardActions>
                </Card>
                ...
                <Card style={componentStyles.card}>
                    ...
                    <CardActions>
                        <KBSRaisedButton label='Abrir' primary={true} onTouchTap={this.openRotulo2.bind(this)} />
                    </CardActions>
                </Card>
            </div>
        )
