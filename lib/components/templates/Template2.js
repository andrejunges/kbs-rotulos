        ...
        <div style={{height: '100%'}}>
            <div style={{border: '1px double #000', padding: '5px 0 0 0'}}>
                ...
                <div style={{borderTop: border, fontSize: '14px', fontWeight: 500, display: 'flex'}}>
                    ...
                    <div style={{flex: '0 0 29%', padding: '3px', borderLeft: border, textAlign: 'center'}}>Order-Nr.</div>
                    <div style={{flex: '0 0 30%', padding: '3px', borderLeft: border, textAlign: 'center'}}>Barcode</div>
                </div>
                ...
                <div style={{fontSize: '24px', fontWeight: 'bold', display: 'flex', borderTop: border}}>
                    ...
                    <div style={{flex: '0 0 29%', padding: '10px', borderLeft: border, textAlign: 'center'}}>{props.data.order || '1512-415'}</div>
                    <div style={{flex: '0 0 30%', padding: '10px', borderLeft: border, textAlign: 'center'}}></div>
                </div>
                ...
                <div style={{borderTop: border, display: 'flex'}}>
                    ...
                    <div style={{flex: '0 0 20%', display: 'flex', justifyContent: 'center', borderRight: border, height: '54px'}}>
                        <span style={{alignSelf: 'flex-end', fontSize: '22px', padding: '5px 10px 5px 5px', display: 'inline-block', borderRight: border}}>1</span>
